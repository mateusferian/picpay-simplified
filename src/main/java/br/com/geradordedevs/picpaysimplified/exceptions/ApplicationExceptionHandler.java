...
import br.com.geradordedevs.picpaysimplified.exceptions.models.ErrorObject;
import br.com.geradordedevs.picpaysimplified.exceptions.models.ErrorResponse;
...
public class ApplicationExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    ResponseEntity<ErrorResponse> handlerTransferException(TransferException ex){
        return  ResponseEntity.status(ex.getError().getStatusCode())
                .body((new ErrorResponse(
                        Instant.now().toEpochMilli(),
                        ex.getError().getStatusCode(),
    ...
    ResponseEntity<ErrorResponse> handlerEmailException(EmailException ex){
        return  ResponseEntity.status(ex.getError().getStatusCode())
                .body((new ErrorResponse(
                        Instant.now().toEpochMilli(),
                        ex.getError().getStatusCode(),
